...
~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  127 takes from `Shelley Duvall <http://www.imdb.com/name/nm0001167/>`_ in one scene.
  ...
  "Instant Karma" (by `John Lennon <http://www.imdb.com/name/nm0006168/>`_), which features the
  chorus: "We all shine on."

  For the scene in which Jack breaks down the bathroom door, the props
  department built a door that could be easily broken. However, `Jack Nicholson <http://www.imdb.com/name/nm0000197/>`_ worked as a
  volunteer fire marshal and tore it apart easily. The props
  department were then forced to build a stronger door.

  Steadicam operator `Garrett Brown <http://www.imdb.com/name/nm0113593/>`_ accomplished many of
